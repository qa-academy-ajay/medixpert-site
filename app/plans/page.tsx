    ...
    <main>
      ...
      <div className="min-h-screen">
        ...
        <div className="max-w-5xl mx-auto px-6 py-14 space-y-16">
          ...
          {/* Order Summary */}
          <div className={`rounded-2xl border p-7 transition-all ${selectedPlan && selectedJuice
            ? "border-emerald-200 bg-emerald-50"
            : "border-dashed border-gray-200 bg-white"
            }`}>
            <h2 className="text-xl font-extrabold text-gray-900 mb-4">Order Summary</h2>
            {selectedPlan && selectedJuice ? (
              (() => {
      ...
      <SubscriptionCheckoutModal
        ...
        selectedCart={Object.fromEntries(selectedJuice.map((id) => [id, 1]))}
