      ...
      <div className="bg-white border-b border-gray-100 px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 text-lg max-w-2xl">
            Discover why thousands of people love NaturoAmrit juices. Read real stories of transformation and health improvement.
          </p>
        </div>
      </div>
      ...
      <section className="px-6 py-16 bg-emerald-50 border-t border-emerald-100 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-emerald-700 mb-6">
            Haven't tried NaturoAmrit yet? Start your transformation today.
          </p>
          <Link
            href="/"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Share your experience with NaturoAmrit (minimum 20 characters)"
              rows={5}
              className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-400 ${
