    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-20">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <blockquote className="border-l-4 border-emerald-500 pl-5 text-gray-600 italic mb-5 leading-relaxed text-sm">
              &quot;At NaturoAmrit By KB Herbals, we believe health begins with nature. Inspired by centuries-old Ayurvedic practices, we craft herbal juices that support immunity, detoxification, and overall vitality — all while being affordable and accessible to everyone.&quot;
            </blockquote>
            <p className="text-gray-600 leading-relaxed text-sm">
              Rooted in the heartland of Gurgaon, India, NaturoAmrit By KB Herbals was founded with a simple passion: to make authentic Ayurvedic therapy available to every household — not just a privileged few.
            </p>
          </div>
        ...
        <section>
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 mb-8">The NaturoAmrit By KB Herbals difference</h2>
        ...
        <section className="bg-emerald-50 border border-emerald-100 rounded-2xl px-8 py-12 text-center">
          <h2 className="text-3xl font-extrabold text-emerald-900 mb-3">Join the NaturoAmrit By KB Herbals family</h2>
